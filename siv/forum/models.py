...
class WorryMessage(models.Model):
    ...
    message_updated = models.DateTimeField(null=True)
...
class OpinionMessage(models.Model):
    ...
    publish_date = models.DateTimeField(default=timezone.now)
    opinion_updated = models.DateTimeField(null=True)
...
class UserAction(models.Model):
    ...
    worry_message = models.ForeignKey(WorryMessage, on_delete=models.CASCADE, null=True)
    opinion_message = models.ForeignKey(OpinionMessage, on_delete=models.CASCADE, null=True)
